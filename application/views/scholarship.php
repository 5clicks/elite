				...
				<div class="row clearfix">
					...
					<div class="grid_8 posts s-thumbnails">
						...
						<div class="post type-post status-publish format-standard has-post-thumbnail hentry clearfix" >
							<a href="#" class="thumb-small fll" >
								<img src="<?=base_url();?>uploads/thumbs/<?php echo $row['picture'];?>" alt="<?php echo $row['title'];?>"/>
							</a>
							<div class="content-two-third">
								<div class="meta-box">
									<h3><a href="#"><?php echo $row['title'];?> </a></h3>									
									<div class="meta-more">
										<span><i class="icon-user"></i> <a href="#" title="Posts by <?php echo $row['createdby'];?>" rel="author"><?php echo $row['createdby'];?></a></span>
										<span><i class="icon-time"></i><a href="#"><?php echo $row['createdat'];?></a></span>
									</div><!-- meta date -->
								</div>
